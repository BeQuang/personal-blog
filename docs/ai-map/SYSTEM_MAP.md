...
- 351 file source/config đã quét, 82,583 dòng.
- 25 page route.
- 15 Route Handler.
- 2 metadata route.
- 77 module component, 54 Client Component.
- 20 bảng PostgreSQL, 15 enum.
- 40 biến môi trường được khai báo hoặc tham chiếu.
